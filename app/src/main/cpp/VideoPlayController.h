...
#ifndef ANDROID_QUIET_VIDEOPLAYER_VIDEOPLAYCONTROLLER_H
#define ANDROID_QUIET_VIDEOPLAYER_VIDEOPLAYCONTROLLER_H
...
class VideoPlayController
        : public IMediaDataReceiver, public IAudioFrameProvider, public IVideoFrameProvider {
public:
    VideoPlayController();
...
#endif //ANDROID_QUIET_VIDEOPLAYER_VIDEOPLAYCONTROLLER_H
