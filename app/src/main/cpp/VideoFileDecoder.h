...
#ifndef ANDROID_QUIET_VIDEOPLAYER_VIDEOFILEDECODER_H
#define ANDROID_QUIET_VIDEOPLAYER_VIDEOFILEDECODER_H
...
public:
    ...
    void removeDataReceiver(IMediaDataReceiver *receiver);
...
#endif //ANDROID_QUIET_VIDEOPLAYER_VIDEOFILEDECODER_H
