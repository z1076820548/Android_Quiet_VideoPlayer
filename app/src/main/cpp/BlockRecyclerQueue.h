...
#ifndef ANDROID_QUIET_VIDEOPLAYER_BLOCKRECYCLERQUEUE_H
#define ANDROID_QUIET_VIDEOPLAYER_BLOCKRECYCLERQUEUE_H
...
public:
    //if size==-1,then we don't limit the size of data queue,and all the put opition will not wait
...
#endif //ANDROID_QUIET_VIDEOPLAYER_BLOCKRECYCLERQUEUE_H
